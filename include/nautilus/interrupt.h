...
#define NK_IVEC_DESC_FLAG_EXCEPTION (1<<1) // This vector is an exception vector and should not be used for regular IRQ's
#define NK_IVEC_DESC_FLAG_MSI       (1<<2)
#define NK_IVEC_DESC_FLAG_MSI_X     (1<<3)
#define NK_IVEC_DESC_FLAG_PERCPU    (1<<4)
#define NK_IVEC_DESC_FLAG_IPI       (1<<5)

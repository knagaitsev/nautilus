...
#define nk_port_gpio_output_set(x) nk_port_gpio_output_mask(x,GPIO_SET)
...
#define NK_GPIO_OUTPUT_MASK(m,o) nk_port_gpio_output_mask(m,o)
#define NK_GPIO_OUTPUT_SET(x) nk_port_gpio_output_set(x)
#define NK_GPIO_INPUT_GET() nk_port_gpio_input_get()
#else
